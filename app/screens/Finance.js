    ...
    return (
        <View style={{flex: 1, backgroundColor: '#FFF'}}>
            {partialGains ? (
                ...
                <Text style={{color: '#888', marginVertical: 10}}>Nenhuma informação financeira ainda.</Text>                
            )}

            <View style={{ borderRadius: 7, padding: 10, paddingVertical: 20, margin: 20 }}>
                ...
                {extractList.length > 0 ? (
                            ...
                            <View key={item._id}>
                                ...
                                {item.receipts.length ? (
                                    <FlatList
                                        ...
                                        ItemSeparatorComponent={() => <View style={{ borderColor: '#EEE', borderWidth: 0.2 }} />}
                                        showsVerticalScrollIndicator={false}
                                    />
                                ) : (
                                    <Text>Nenhum lançamento para essa data.</Text>
                                )}
                    ...
                    <Text style={{color: '#888', marginVertical: 10}}>Nenhum lançamento ainda.</Text>
                )}
            </View>
        </View>
    )
